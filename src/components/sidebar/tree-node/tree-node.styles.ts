...
export const useStyles = () => ({
  root: tw`relative`,
  container: tw`flex items-center gap-2 py-1 px-2 cursor-pointer hover:bg-accent/50 rounded-md transition-colors group relative pr-8`,
  iconWrapper: tw`flex items-center justify-center w-4 h-4 shrink-0`,
  spinner: tw`w-3 h-3`,
  chevronIcon: tw`w-4 h-4 text-muted-foreground`,
